...
import sty from "./PlasmicTemplate2.module.css"; // plasmic-import: PebR7r49CnQ/css
          ...
          {$ctx => (
            <React.Fragment>
              {true ? (
                ...
                >
                  <div
                    className={classNames(projectcss.all, sty.freeBox___4PyoA)}
                  >
                    <p.PlasmicImg
...
const PlasmicDescendants = {
  ...
  hero: ["hero", "img", "contentWrapper", "title", "span", "date"],
  img: ["img"],
  contentWrapper: ["contentWrapper", "title", "span", "date"],
  title: ["title"],
  span: ["span"],
  date: ["date"],
  content: [
